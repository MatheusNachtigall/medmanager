<%@ Page ClientIDMode="AutoID" Title="" Language="C#" MasterPageFile="~/painel/Interna/Interna.master" AutoEventWireup="true" CodeFile="Editar.aspx.cs" Inherits="Manager_Modulos_Clientes_Cadastros_Editar" ValidateRequest="false" %>
	...
	<asp:UpdatePanel runat="server" ID="upConteudo">
        <ContentTemplate> 
			...
			<div class="p20 pt0">
				...
				<div class="select">
					<asp:DropDownList runat="server" ID="ddlAgencia" Width="678px" ClientIDMode="Static"></asp:DropDownList>
				</div>
			</div>
