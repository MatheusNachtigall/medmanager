...
public partial class Manager_Modulos_Relatorios_Recebimento_Listar : System.Web.UI.Page
{
    #region Eventos
    ...
    private void CarregarLista()
    {
		...
		List<ListaRelatorio> lista = new _APP_ADO().GET_RELATORIO_RECEBIMENTO_DATA( (RelatorioFiltro)Session["RELATORIO_Filtro"] );

		hdDados.Value = JsonConvert.SerializeObject(lista);
		hdNome.Value = "Recebimento";
	...
	private void CarregarCombos()
	{
		...
		List<ListaRelatorio> lista = new _APP_ADO().GET_RELATORIO_RECEBIMENTO_DATA(filtro);
