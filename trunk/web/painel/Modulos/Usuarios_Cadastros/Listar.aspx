<%@ Page ClientIDMode="AutoID" Title="" Language="C#" MasterPageFile="~/painel/Interna/Interna.master" AutoEventWireup="true" CodeFile="Listar.aspx.cs" Inherits="Manager_Modulos_Usuarios_Cadastros_Listar" %>
            ...
            <asp:Panel ID="pnlRegistrosEncontrados" runat="server">
                ...
                <ItemTemplate>
                    <tr>
						...
						<td class="td-detalhe"><asp:Literal runat="server" ID="ltlEmail"></asp:Literal></td>
