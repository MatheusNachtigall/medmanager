<%@ Page ClientIDMode="AutoID" Title="" Language="C#" MasterPageFile="~/painel/Interna/Interna.master" AutoEventWireup="true" CodeFile="Listar.aspx.cs" Inherits="Manager_Modulos_Relatorios_Graficos_Listar" %>
            ...
            <asp:Panel ID="pnlRegistrosEncontrados" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="mask-money"><asp:Literal runat="server" ID="ltlINSS"></asp:Literal></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    </tbody>
