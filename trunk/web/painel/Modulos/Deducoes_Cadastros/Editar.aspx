<%@ Page ClientIDMode="AutoID" Title="" Language="C#" MasterPageFile="~/painel/Interna/Interna.master" AutoEventWireup="true" CodeFile="Editar.aspx.cs" Inherits="Manager_Modulos_Deducoes_Cadastros_Editar" ValidateRequest="false" %>
	...
	<asp:UpdatePanel runat="server" ID="upConteudo">
        <ContentTemplate>
			...
			<div class="p20 pt0">
                ...
                <div class="select">
                    <asp:DropDownList runat="server" ID="ddlTipo" Width="324px" ClientIDMode="Static"></asp:DropDownList>
                </div>
                ...
                <div class="clearfix pb10">
                    <asp:Label ID="lblPlantaoID" runat="server" AssociatedControlID="ddlPlantaoID">PlantaoID</asp:Label>
                    <div class="select">
                        <asp:DropDownList runat="server" ID="ddlPlantaoID" Width="324px" ClientIDMode="Static"></asp:DropDownList>
                    </div>
                </div>
			</div>

			<div class="p20 pt0">
				<asp:Label ID="lblDataDeducao" runat="server" AssociatedControlID="txtDataDeducao">Data Dedução:</asp:Label>
				<span class="input-txt">
					<asp:TextBox runat="server" ID="txtDataDeducao" CssClass="frmTxt mask-date" Width="678px" MaxLength="256"></asp:TextBox>
				</span>
			</div>
