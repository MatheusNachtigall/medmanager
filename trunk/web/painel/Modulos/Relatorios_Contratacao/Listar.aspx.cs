...
public partial class Manager_Modulos_Relatorios_Contratacao_Listar : System.Web.UI.Page
{
    #region Eventos
    ...
    private void CarregarLista()
    {
		...
		List<ListaRelatorio> lista = new _APP_ADO().GET_RELATORIO_CONTRATACAO_DATA( (RelatorioFiltro)Session["RELATORIO_Filtro"] );

		hdDados.Value = JsonConvert.SerializeObject(lista);
		hdNome.Value = "Contratação";
	...
	private void CarregarCombos()
	{
		...
		List<ListaRelatorio> lista = new _APP_ADO().GET_RELATORIO_CONTRATACAO_DATA(filtro);
