<%@ Page ClientIDMode="AutoID" Title="" Language="C#" MasterPageFile="~/painel/Interna/Interna.master" AutoEventWireup="true" CodeFile="Editar.aspx.cs" Inherits="Manager_Modulos_Usuarios_Cadastros_Editar" ValidateRequest="false" %>
        ...
        <ContentTemplate>
			...
			<div class="p20 pt0">
				...
				<span class="input-txt">
					<asp:TextBox runat="server" ID="txtEmail" CssClass="frmTxt" Width="678px" MaxLength="256"></asp:TextBox>
				</span>
			</div>
			...
			<div class="p20 pt0">
				...
				<span class="input-txt">
					<asp:TextBox runat="server" ID="txtSenha" CssClass="frmTxt" Width="678px" MaxLength="256" TextMode="Password"></asp:TextBox>
				</span>
			</div>
