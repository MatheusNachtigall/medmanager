...
BEGIN
	...
	SELECT
		...
		[INSS].[DATA_INSS] AS [INSS_DATA_INSS],
	...
	WHERE
		...
		AND ([INSS].[DATA_INSS] = @DATA_INSS OR @DATA_INSS IS NULL)
			...
			(
				SELECT
					...
					CASE
						...
						WHEN UPPER(@ordemTipo) = 'DESC' AND UPPER(@ordemCampo) = 'DATA_INSS' THEN CONVERT(SQL_Variant, [INSS].[DATA_INSS])
					...
					CASE
						...
						WHEN UPPER(@ordemTipo) = 'ASC' AND UPPER(@ordemCampo) = 'DATA_INSS' THEN CONVERT(SQL_Variant, [INSS].[DATA_INSS])
