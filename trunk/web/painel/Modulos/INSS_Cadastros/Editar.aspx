<%@ Page ClientIDMode="AutoID" Title="" Language="C#" MasterPageFile="~/painel/Interna/Interna.master" AutoEventWireup="true" CodeFile="Editar.aspx.cs" Inherits="Manager_Modulos_INSS_Cadastros_Editar" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentInterna" runat="Server">
	...
	<asp:UpdatePanel runat="server" ID="upConteudo">
        <ContentTemplate>
			...
			<div class="p20 pt0">
				<asp:Label ID="lblDataCadastro" runat="server" AssociatedControlID="txtDataCadastro">Data Cadastro:</asp:Label>
				<span class="input-txt">
					<asp:TextBox runat="server" ID="txtDataCadastro" CssClass="frmTxt mask-date" Width="678px" MaxLength="256"></asp:TextBox>
				</span>
			</div>
